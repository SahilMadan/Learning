...
float camera_yaw = -90.0f;  // Yaw is turning around the z-azis
float camera_pitch = 0.0f;  // Pitch is tilt on the y-axis
...
void MouseCursorCallback(GLFWwindow*, double x_position, double y_position) {
  ...
  // These can be used to calculate our direction vector.
  glm::vec3 direction;
